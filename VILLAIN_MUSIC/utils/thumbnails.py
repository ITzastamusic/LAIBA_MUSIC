...
arial = ImageFont.truetype("VILLAIN_MUSIC/assets/assets/font2.ttf", 30)
font = ImageFont.truetype("VILLAIN_MUSIC/assets/assets/font.ttf", 30)
title_font = ImageFont.truetype("VILLAIN_MUSIC/assets/assets/font3.ttf", 45)
...
async def get_thumb(videoid):
    ...
    try:
        ...
        draw.text((1280 - text_size[0] - 10, 10), "VILLAIN X BOTS   ", fill="yellow", font=font)
        line_length = 580
        ...
        play_icons = Image.open("VILLAIN_MUSIC/assets/assets/play_icons.png").resize((580, 62))
