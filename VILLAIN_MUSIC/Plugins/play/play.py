...
@app.on_callback_query(filters.regex("villainmousAdmin") & ~BANNED_USERS)
async def villainmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("villainPlaylists") & ~BANNED_USERS)
@languageCB
